...
class Utils:
    ...
    def check_config(app):
        ...
        elif app.config['USER_ID'] == '':
            return 'User ID is not provided in the config.py file'
        elif app.config['RLS_ROLE'] == '':
            return 'RLS Role is not provided in the config.py file'
